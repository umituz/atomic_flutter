...
/// Legacy compatibility for old StatusEnum
@Deprecated('Use AtomicStatus instead')
enum StatusEnum { 
  LOADING, 
  SUCCESS, 
  ERROR, 
  ...
  /// Convert to AtomicStatus
  AtomicStatus get toAtomicStatus {
    switch (this) {
      case LOADING:
        return AtomicStatus.loading;
      case SUCCESS:
        return AtomicStatus.success;
      case ERROR:
        return AtomicStatus.error;
      case EMPTY:
        return AtomicStatus.empty;
      case CANT:
        return AtomicStatus.cannot;
      case TIMEOUT:
        return AtomicStatus.timeout;
    }
  }
}

/// Extension to convert AtomicStatus to legacy StatusEnum if needed
extension AtomicStatusExtension on AtomicStatus {
  /// Convert to legacy StatusEnum (limited support)
  StatusEnum? get toLegacyEnum {
    switch (this) {
      case AtomicStatus.loading:
        return StatusEnum.LOADING;
      case AtomicStatus.success:
        return StatusEnum.SUCCESS;
      case AtomicStatus.error:
        return StatusEnum.ERROR;
      case AtomicStatus.empty:
        return StatusEnum.EMPTY;
      case AtomicStatus.cannot:
        return StatusEnum.CANT;
      case AtomicStatus.timeout:
        return StatusEnum.TIMEOUT;
      default:
        return null; // idle, cancelled, warning have no legacy equivalent
    }
  }
} 